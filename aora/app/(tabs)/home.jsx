...
//           >
//             <Text style={styles.gridText}>Complaint Registration</Text>
//           </TouchableOpacity>
//         </View>
//       </View>
    ...
    <View style={styles.container}>
      ...
      <View style={styles.gridContainer}>
        ...
        <View style={styles.gridItem}>
          ...
          <TouchableOpacity
            style={styles.gridButton}
            onPress={() => router.push('/complaint')} // Using router.push for navigation
          >
            <Text style={styles.gridText}>Complaint Registration</Text>
          </TouchableOpacity>
        </View>
      ...
      <TouchableOpacity
        ...
        onPress={() => {
          console.log('SOS Button pressed'); // Log for debugging
          router.push('/soscall'); // Navigate to SOSCall
        }}
      >
        <Text style={styles.sosText}>SOS</Text>
      </TouchableOpacity>
